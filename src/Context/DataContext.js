...
export const DataProvider = (props) => {
  const dataSource = {
    ...
    about: {
      ...
      mainParagrah: `Planificar, organizar, dirigir y controlar los sistemas de
      telecomunicaciones y el desarrollo informático institucional en
      los ámbitos técnicos y de entrenamiento informático.`,
      subParagrah: `Estará conformado por los departamentos de Informática, Redes e
      Infraestructura Teleinformática y Comunicaciones.`,
    },
    departments: {
      ...
      departmentItems: [
        {
          ...
          iconColor: "#ff689b",
          title: "Informática",
          description: "Seccion de software y desarrolo ",
          id: 1,
        },
        {
          layout: {
